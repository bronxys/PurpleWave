...
<div align="center">
<img src="https://img.shields.io/badge/Entretenimento-GRÁTIS-FF5722?style=for-the-badge&logo=play&logoColor=white" alt="Strimz"/>
</div>

O entretenimento que você sempre quis está chegando! Acesso **GRATUITO** a Filmes completos, Séries, Vídeos sem anúncios, Música, Animes, Conteúdos virais, Documentários. Tudo em um só lugar!

**🔗 [Acessar Strimz](https://chat.whatsapp.com/L5TXYJ9x5E68PjfwxAIDw4)**
...
1. Acesse [Obsisian APIs](https://hobsidian.shop/)
...
<details>
<summary>🔧 <strong>Como configurar a API do Obsidian APIs?</strong></summary>

1. Acesse [Obsidian APIs](https://hobsidian.shop/)
2. Faça login e crie uma API Key
3. Adicione no arquivo `.json`: `"apikey": "API-KEY"`
4. Reinicie o bot

</details>

<details>
<summary>📱 <strong>Funciona no WhatsApp Business?</strong></summary>

✅ **Sim!** O bot é totalmente compatível com:
- WhatsApp Pessoal
- WhatsApp Business
...
<details>
<summary>🚫 <strong>Bot não está respondendo?</strong></summary>

Verifique:
- ✅ Bot está online (terminal ativo)
- ✅ Prefixo correto (padrão: `!`)
...
<details>
<summary>⚡ <strong>Como melhorar a performance?</strong></summary>

- 🔧 Use Node.js v18+
- 💾 Mantenha pelo menos 1GB RAM livre
